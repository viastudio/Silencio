...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'silencio' ),
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use silencio_comment() to format the comments.
				 * If you want to override this in a child theme, then you can
				 * define silencio_comment() and that will be used instead.
				 * See silencio_comment() in inc/template-tags.php for more.
				 */
