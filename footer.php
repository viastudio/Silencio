...
<?php
if ((
    $street = get_theme_mod('theme_option_street_txt_input')) != '') {
?>
                            <li><span itemprop="street-address"><?php echo $street; ?></span></li>
<?php
} if ((
    $city = get_theme_mod('theme_option_city_txt_input')) != '') {
?>
                            <li><span itemprop="locality"><?php echo $city; ?></span>,
<?php
} if ((
    $state = get_theme_mod('theme_option_state_txt_input')) != '') {
?>
                                <span itemprop="region"><?php echo $state; ?></span>
<?php
} if ((
    $zip = get_theme_mod('theme_option_zip_txt_input')) != '') {
?>
                                <span itemprop="postal-code"><?php echo $zip; ?></span></li>
<?php
} if ((
    $phone = get_theme_mod('theme_option_phone_txt_input')) != '') {
?>
                            <li><span itemprop="tel"><?php echo $phone; ?></span></li>
<?php
} if ((
    $email = get_theme_mod('theme_option_email_txt_input')) != '') {
?>
...
<?php
if ((
    $facebook = get_theme_mod('theme_option_facebook_txt_input')) != '') {
?>
                            <li><a href="<?php echo $facebook; ?>"><i class="fa fa-facebook"></i></a></li>
<?php
} if ((
    $twitter = get_theme_mod('theme_option_twitter_txt_input')) != '') {
?>
                            <li><a href="<?php echo $twitter; ?>"><i class="fa fa-twitter"></i></a></li>
<?php
} if ((
    $youtube = get_theme_mod('theme_option_youtube_txt_input')) != '') {
?>
                            <li><a href="<?php echo $youtube; ?>"><i class="fa fa-youtube-play"></i></a></li>
<?php
} if ((
    $googleplus = get_theme_mod('theme_option_googleplus_txt_input')) != '') {
?>
